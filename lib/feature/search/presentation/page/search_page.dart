                    ...
                    ? CustomScrollView(
                        ...
                        slivers: [
                          ...
                          Obx(() {
                            ...
                            if (productSuggestState.status == Status.success) {
                            ...
                            if (productSuggestState.status == Status.loading) {
                              return SliverList(
                                delegate: SliverChildBuilderDelegate(
                                    (context, index) {
                                  return Padding(
                    ...
                    : CustomScrollView(
                        slivers: [
                          ...
                          Obx(() {
                            ...
                            if (mostSearhcProductState.status == Status.error) {
                              return SliverToBoxAdapter(
                                child: Container(
                                  color: Get.theme.scaffoldBackgroundColor,
                                  padding: const EdgeInsets.all(kMediumPadding),
